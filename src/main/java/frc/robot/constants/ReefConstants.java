...
public class ReefConstants {
    ...
    public static final ReefAlignment.BranchTarget[] REEF_ALIGNMENT_POSITIONS_RED = new ReefAlignment.BranchTarget[] {
        new ReefAlignment.BranchTarget(
                Rotation2d.fromDegrees(180), new Translation2d(15, 3.8), new Translation2d(14.37, 3.89), 7, false),
        new ReefAlignment.BranchTarget(
                Rotation2d.fromDegrees(180), new Translation2d(15, 4.2), new Translation2d(14.37, 4.15), 7, true),
        new ReefAlignment.BranchTarget(
        ...
        new ReefAlignment.BranchTarget(
                Rotation2d.fromDegrees(60), new Translation2d(12.3, 2.1), new Translation2d(12.53, 2.82), 11, true),
        new ReefAlignment.BranchTarget(
                Rotation2d.fromDegrees(120), new Translation2d(13.9, 2.1), new Translation2d(13.60, 2.82), 6, false),
        new ReefAlignment.BranchTarget(
                Rotation2d.fromDegrees(120), new Translation2d(14.3, 2.3), new Translation2d(13.83, 2.96), 6, true)
    };
}
